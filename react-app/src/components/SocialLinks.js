...
export default function SocialLinks() {
  return (
    <div className='flex flex-col top-[35%] left-0 fixed'>
      <ul>
        <li className='flex justify-between items-center w-40 h-14 px-4 ml-[-100px] rounded-md bg-gray-500 hover:rounded-none duration-300 hover:border hover:border-black'>
